...
namespace XLY.SF.Project.PreviewFilesView.PreviewFile
{
    ...
    public class MediaElement : FrameworkElement, IFileViewer
    {
        ...
        //==========================================================================
        private static readonly ConcurrentDictionary<MediaPlayer, Lib.WeakReference<MediaElement>> m_MediaElements = new ConcurrentDictionary<MediaPlayer, Lib.WeakReference<MediaElement>>();
        ...
        private static MediaElement GetMediaElement(MediaPlayer mediaPlayer)
        {
            ...
            Lib.WeakReference<MediaElement> reference;
        ...
        private void OnMediaPlayerChanged(MediaPlayer oldValue, MediaPlayer newValue)
        {
            ...
            if (newValue != null)
            {
                m_MediaElements.TryAdd(newValue, new Lib.WeakReference<MediaElement>(this));
        ...
        static MediaElement()
        {
            if (!(bool)(DesignerProperties.IsInDesignModeProperty.GetMetadata(typeof(DependencyObject)).DefaultValue))
            {
                m_Library = LibVLCLibrary.Load(AppDomain.CurrentDomain.BaseDirectory+ @"\RefDlls\Libvlc\");
            }
