        ...
        private void LoadData(string devicePath)
        {
            Task.Factory.StartNew(() =>
            {
                ...
                var dataList = new ObservableCollection<DataExtactionItem>() {
                    new DataExtactionItem(){Text = "自动提取", IsItemStyle=true, TreeNodes = new ObservableCollection<DataExtactionItem>(){
                ...
                //    DataExtactionItem extact = new DataExtactionItem() { Text = d.Name, IsItemStyle = true, TreeNodes = new ObservableCollection<DataExtactionItem>() };
                //    dataList.Add(extact);
                ...
                //    {
                //        DataExtactionItem g = new DataExtactionItem() { Text = group.Key, IsItemStyle = false, TreeNodes = new ObservableCollection<DataExtactionItem>() };
