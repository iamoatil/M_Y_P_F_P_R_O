...
namespace XLY.SF.Project.DataDisplayView
{
	...
	internal class Languagekeys
	{
        ...
        /// 是否删除数据'{0}'?
        /// </summary>
		public static readonly Languagekeys DeleteNotice = "LanguageResource/DeleteNotice";
				
        /// <summary>
        /// 系统提示
        /// </summary>
		public static readonly Languagekeys DeleteNoticeTitle = "LanguageResource/DeleteNoticeTitle";
				
        /// <summary>
        /// 正在删除数据...
        /// </summary>
		public static readonly Languagekeys DeletingData = "LanguageResource/DeletingData";
				
        /// <summary>
        /// 未打开智能检视!
        /// </summary>
		public static readonly Languagekeys NotOpenInspectionTip = "LanguageResource/NotOpenInspectionTip";
