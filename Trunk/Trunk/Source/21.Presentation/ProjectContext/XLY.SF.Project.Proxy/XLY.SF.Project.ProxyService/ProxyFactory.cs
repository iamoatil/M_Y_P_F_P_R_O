...
namespace XLY.SF.Project.ProxyService
{
    ...
    public class ProxyFactory
    {
        ...
        #region 本地文件提取服务
        private static volatile LocalFileProxy _localFileProxy;
        /// <summary>
        /// 本地文件提取服务
        /// </summary>
        public static LocalFileProxy LocalFile
        {
            get
            {
                if (_localFileProxy == null)
                {
                    lock (_objLock)
                    {
                        if (_localFileProxy == null)
                            _localFileProxy = new LocalFileProxy();
                    }
                }
                return _localFileProxy;
            }
        }
        #endregion
