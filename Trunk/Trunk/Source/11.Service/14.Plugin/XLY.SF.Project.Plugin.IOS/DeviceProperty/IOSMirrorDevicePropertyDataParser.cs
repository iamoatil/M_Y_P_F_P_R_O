...
{
    public class IOSMirrorDevicePropertyDataParser : AbstractDataParsePlugin
    {
        public override IPluginInfo PluginInfo { get; set; }

        public IOSMirrorDevicePropertyDataParser()
        {
            DataParsePluginInfo pluginInfo = new DataParsePluginInfo();
            pluginInfo.Guid = "{1F3F5C26-35C1-4CA9-B855-0313AD432371}";
            ...
            pluginInfo.Description = LanguageHelper.GetString(Languagekeys.PluginDescription_IosMirrorDeviceProperty);
