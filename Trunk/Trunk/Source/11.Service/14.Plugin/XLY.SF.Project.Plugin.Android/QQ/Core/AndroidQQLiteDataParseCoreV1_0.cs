...
namespace XLY.SF.Project.Plugin.Android
{
    ...
    /// 安卓QQ轻聊版数据解析核心类
    /// </summary>
    internal class AndroidQQLiteDataParseCoreV1_0
    {
        /// <summary>
        /// 安卓QQ轻聊版数据解析核心类
        /// </summary>
        ...
        /// <param name="datapath">QQ数据文件根目录，例如 I:\本地数据\com.tencent.qqlite</param>
        /// <param name="mediapath">QQ多媒体文件夹根目录，例如 I:\本地数据\Tencent\QQLite</param>
        public AndroidQQLiteDataParseCoreV1_0(string savedatadbpath, string name, string datapath, string mediapath)
        {
