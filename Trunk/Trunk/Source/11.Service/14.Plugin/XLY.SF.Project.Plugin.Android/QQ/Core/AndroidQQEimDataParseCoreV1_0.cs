...
namespace XLY.SF.Project.Plugin.Android
{
    ...
    /// 安卓企业QQ数据解析核心类
    /// </summary>
    internal class AndroidQQEimDataParseCoreV1_0
    {
        /// <summary>
        /// 安卓企业QQ数据解析核心类
        /// </summary>
        ...
        /// <param name="mediapath">QQ多媒体文件夹根目录，例如 I:\本地数据\Tencent\EimQQ</param>
        public AndroidQQEimDataParseCoreV1_0(string savedatadbpath, string name, string datapath, string mediapath)
        {
        ...
        /// <summary>
        /// QQ数据文件根目录，例如 I:\本地数据\com.tencent.eim
        ...
        /// <summary>
        /// QQ多媒体文件夹根目录，例如 I:\本地数据\Tencent\EimQQ
        ...
        private string GetRecoverTables(string oldDbPath)
        {
            ...
            string[] baseTables = { "Card", "Friends", "Groups", "TroopInfo", "TroopInfoV2", "TroopMemberInfo", "DiscussionInfo", "DiscussionMemberInfo", "mr_fileManager", "recent" };
