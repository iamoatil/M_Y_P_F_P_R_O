...
namespace XLY.SF.Project.Domains
{
    ...
    /// 可以标记的数据装饰属性
    /// </summary>
    public class BookmarkDecorationProperty : DecorationProperty
    {
        public BookmarkDecorationProperty(object defaultValue = null, object metaData = null, EventHandler<DecorationArgs> onChanged = null) : base(defaultValue, metaData, onChanged)
        {
            _cacheData = new CacheData<object, object>(2000);
        }
        public const string DPTableName = "t_bookmark";
        public const string DPDBName = "data_bmk.db";   //数据库文件名称
        ...
        public override void SetValue(object obj, object value, bool isTriggerByChild)
        {
            ...
            {
                SqliteCache.ExecuteNonQuery(param.chkDB, $"REPLACE INTO {DPTableName} ({StateColName}, {KeyColName}) values ({value}, '{param.key}');");
            }
