...
//        //[TestMethod]
//        //public void TestExecuteMethod(Pump pump, SourceFileItem source, ITaskProgressReporter reporter, params ExtractItem[] items)
//        //{
...
//        //[TestMethod]
//        //public void TestCancelMethod(Pump pump, SourceFileItem source, ITaskProgressReporter reporter, params ExtractItem[] items)
//        //{
//        //    DataPumpBase dp = pump.GetDataPump();
//        //    DataPumpExecutionContext context = dp.Execute(source, reporter, items);
//        //    context.Cancel();
